...
ALTER TABLE "special_offers" ADD CONSTRAINT "special_offers_min_order_currency_id_currencies_id_fk" FOREIGN KEY ("min_order_currency_id") REFERENCES "public"."currencies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
