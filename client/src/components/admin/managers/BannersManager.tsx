...
// Создаем более гибкую схему для формы редактирования
const bannerFormSchema = z.any();
import { apiRequest, queryClient } from "@/lib/queryClient";
import { ObjectUploader } from "@/components/ObjectUploader";
import { Plus, Edit, Trash2, Eye, EyeOff, BarChart3, Target, Calendar, Palette, Check, ChevronsUpDown, X as IconX } from "lucide-react";
