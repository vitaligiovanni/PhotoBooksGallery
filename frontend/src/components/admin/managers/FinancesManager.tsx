...
export function FinancesManager() {
  ...
  // For now, use empty transactions array since backend doesn't have transaction endpoints yet
  ...
  const stats = {
    totalIncome: financeData?.totalRevenue || 0,
    totalExpense: 0, // Backend doesn't track expenses yet
    netProfit: financeData?.totalRevenue || 0,
    transactionCount: financeData?.totalOrders || 0
  };
  ...
  const createTransactionMutation = useMutation({
    mutationFn: async (data: any) => {
      // TODO: Implement transaction creation endpoint in backend
      console.log("Would create transaction:", data);
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Информация",
        description: "Функция создания транзакций будет реализована в следующей версии",
        variant: "destructive"
      });
    }
  });
  ...
  const deleteTransactionMutation = useMutation({
    mutationFn: async (id: string) => {
      // TODO: Implement transaction deletion endpoint in backend
    ...
    onSuccess: () => {
      toast({
        title: "Информация", 
        description: "Функция удаления транзакций будет реализована в следующей версии",
        variant: "destructive"
      });
    }
  });
