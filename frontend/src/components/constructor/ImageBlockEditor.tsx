...
type ImageBlockContentLang = { imageUrl?: string; alt?: string; align?: string; link?: string };
interface ImageBlockContent { ru?: ImageBlockContentLang; hy?: ImageBlockContentLang; en?: ImageBlockContentLang; [k: string]: any }

export function ImageBlockEditor({ block, onChange, onSave, onCancel, isSaving }: ImageBlockEditorProps) {
  const content: ImageBlockContent = (block.content as any) || { ru: {} };
